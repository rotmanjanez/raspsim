...
inline constexpr word_t syscall_readv = 19;
inline constexpr word_t syscall_writev = 20;
...
inline constexpr word_t syscall_tkill = 200;
inline constexpr word_t syscall_futex = 202;
inline constexpr word_t syscall_tgkill = 234;
