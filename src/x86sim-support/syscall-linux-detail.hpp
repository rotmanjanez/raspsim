...
inline constexpr word_t syscall_flock = 73;
inline constexpr word_t syscall_fsync = 74;
inline constexpr word_t syscall_fdatasync = 75;
...
inline constexpr word_t syscall_link = 86;
inline constexpr word_t syscall_unlink = 87;
inline constexpr word_t syscall_symlink = 88;
...
inline constexpr word_t syscall_statfs = 137;
inline constexpr word_t syscall_fstatfs = 138;
...
inline constexpr word_t syscall_linkat = 265;
inline constexpr word_t syscall_symlinkat = 266;
inline constexpr word_t syscall_readlinkat = 267;
inline constexpr word_t syscall_fchmodat = 268;
...
inline constexpr word_t syscall_fallocate = 285;
...
inline constexpr word_t syscall_statx = 332;
inline constexpr word_t syscall_faccessat2 = 439;

inline constexpr int linux_eperm = 1;
...
inline constexpr int linux_eexist = 17;
inline constexpr int linux_exdev = 18;
inline constexpr int linux_enotdir = 20;
inline constexpr int linux_eisdir = 21;
inline constexpr int linux_enotty = 25;
inline constexpr int linux_einval = 22;
inline constexpr int linux_emfile = 24;
inline constexpr int linux_efbig = 27;
inline constexpr int linux_enospc = 28;
inline constexpr int linux_espipe = 29;
inline constexpr int linux_emlink = 31;
inline constexpr int linux_erange = 34;
inline constexpr int linux_enotempty = 39;
inline constexpr int linux_eloop = 40;
